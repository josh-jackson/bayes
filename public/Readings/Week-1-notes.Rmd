...
Everything that we are going to do in class is just an extension of these simple examples. Your prior knowledge of statistics `will get in the way` so be sure to read through the text and examples multipe times. 
